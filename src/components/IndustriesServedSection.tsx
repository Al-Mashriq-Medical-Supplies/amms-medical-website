...
const industries = [
  {
    ...
    description: 'Comprehensive equipment packages for tertiary hospitals and multi-specialty centers across the UAE.',
    metric: '35+',
    label: 'Years Serving',
  },
  {
  ...
  },
  {
    ...
    description: 'Physiotherapy and cardiac rehabilitation equipment for specialized recovery.',
    metric: '15+',
    label: 'Product Lines',
  },
  {
    title: 'Diagnostic Centers',
    description: 'Advanced ophthalmic, hearing, and pulmonary diagnostic equipment for clinical laboratories.',
    metric: '30+',
    label: 'Professionals',
  },
  {
    title: 'Homecare & Long-Term Care',
    description: 'Patient-friendly CPAP, respiratory, and homecare products for chronic disease management at home.',
    metric: '7',
