...
export default function Footer() {
  return (
    <footer className="bg-[var(--color-navy)] text-white border-t-0">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 pb-12 lg:pt-12 lg:pb-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-8">
          ...
          <div className="sm:col-span-2 lg:col-span-4 pr-0 lg:pr-12">
            ...
            <p className="text-[13px] text-white/70 font-normal leading-relaxed max-w-sm mb-6">
            ...
            <ul className="space-y-4">
              {quickLinks.map((link) => (
                <li key={link.href}>
                  <Link
                    href={link.href}
                    className="text-[13px] font-medium text-white/70 hover:text-[var(--color-gold)] transition-colors"
                  >
                    {link.label}
                  </Link>
                </li>
          ...
          <div className="lg:col-span-2">
            <h4 className="text-white font-bold mb-6 text-[15px]">
              Specialties
            </h4>
            <ul className="space-y-4">
          ...
          <div className="lg:col-span-2">
            ...
            <ul className="space-y-4">
              <li className="flex items-center gap-3 text-[13px] font-medium text-white/70">
                <Phone
                  size={16}
                  className="text-[var(--color-brand)] shrink-0 fill-current"
                  strokeWidth={0}
                />
                <a
      ...
      <div className="border-t border-white/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-[12px] font-medium text-white/50 text-center md:text-left">
            &copy; Copyright by Al Mashriq Medical Supplies. All rights
            reserved.
          </p>
          <div className="flex flex-wrap justify-center space-x-6 text-[12px] font-medium text-white/50">
            <Link
              href="/about"
              className="hover:text-[var(--color-gold)] transition-colors"
            >
