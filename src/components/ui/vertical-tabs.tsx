        ...
        <div className="grid grid-cols-1 items-start gap-12 lg:grid-cols-12 lg:gap-16">
          <div className="order-2 flex flex-col justify-center pt-4 lg:order-1 lg:col-span-5">
            <div className="mb-12 space-y-1">
              <h2 className="text-balance font-playfair text-3xl font-medium tracking-tight text-foreground md:text-4xl lg:text-5xl">
                {title}
              </h2>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex flex-1 flex-col gap-2">
                      <span
                        className={cn(
                          'font-playfair text-2xl font-normal tracking-tight transition-colors duration-500 md:text-3xl lg:text-4xl',
