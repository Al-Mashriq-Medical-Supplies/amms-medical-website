      ...
      <div className="relative z-10 mx-auto h-full w-full max-w-7xl px-4 sm:px-6 lg:px-8 py-12 md:py-32">
        <div className="flex flex-col gap-12 lg:gap-16">
          ...
          <div className="flex w-full flex-col items-center text-center max-w-4xl mx-auto gap-6 lg:gap-8">
            <div>
              <h2 className="font-playfair text-3xl font-light leading-[1.15] tracking-tight md:text-5xl lg:text-6xl text-[var(--color-navy)] max-w-3xl mx-auto mb-4">
                Advancing Patient Care Through Innovation
              </h2>
              <span className="mb-4 block text-[11px] font-medium uppercase tracking-[0.25em] text-[var(--color-brand)]">
                About AMMS
              </span>
            </div>

            <div className="flex flex-col items-center gap-8">
              <p className="text-sm font-light leading-relaxed text-[var(--color-charcoal)] md:text-base lg:text-lg max-w-2xl mx-auto">
                Established in 1991, Al Mashriq Medical Supplies connects
                hospitals, clinics, and care providers with world-class medical
          ...
          <div className="relative w-full h-[400px] md:h-[500px] lg:h-[600px] overflow-hidden bg-[var(--color-muted)] rounded-sm group">
            <Image
            ...
            <div className="absolute bottom-6 left-6 md:bottom-10 md:left-10 border border-white/20 bg-white/10 px-6 py-4 text-white shadow-2xl backdrop-blur-md overflow-hidden">
              ...
              <p className="font-playfair text-3xl font-light relative z-10">
                35<span className="text-[var(--color-brand)]">+</span>
              </p>
