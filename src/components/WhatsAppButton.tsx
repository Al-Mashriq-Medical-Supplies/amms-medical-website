  ...
  return (
    <div className="fixed inset-x-0 bottom-6 md:bottom-8 z-50 pointer-events-none flex justify-end max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <a
        ...
        className="pointer-events-auto flex relative items-center justify-center w-14 h-14 bg-[#25D366] text-white rounded-full shadow-lg hover:shadow-2xl hover:scale-110 transition-all duration-300 group"
